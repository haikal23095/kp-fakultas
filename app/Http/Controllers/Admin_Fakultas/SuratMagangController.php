...
class SuratMagangController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin_fakultas.surat-magang.index', compact('daftarSurat'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin_fakultas.surat-magang.detail', compact('surat', 'dataMahasiswa', 'dataDosenPembimbing'));
    }
    ...
    {
        $request->validate([
            'nomor_surat' => 'required|string|max:100|unique:Surat_Magang,Nomor_Surat',
        ], [
        ...
        // Update nomor surat di Surat_Magang
