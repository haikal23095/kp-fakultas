...
class LegalisirController extends Controller
{
    ...
    public function approve($id)
    {
        ...
        // Pastikan user adalah Dekan (Role 2)
        if ($user->Id_Role != 2) {
        ...
        try {
            ...
            for ($pageNo = 1; $pageNo <= $pageCount; $pageNo++) {
                ...
                if ($pageNo == 1) {
                    ...
                    $pdf->Cell($qrSize + 10, 4, 'Dekan', 0, 0, 'C');
                }
            }
            ...
            if ($adminFakultas) {
                Notifikasi::create([
                    ...
                    'Pesan' => 'Legalisir ' . $legalisir->Jenis_Dokumen . ' untuk ' . ($legalisir->user->Name_User ?? 'mahasiswa') . ' telah ditandatangani oleh Dekan. Status: Siap Diambil.',
            ...
            return redirect()->route('dekan.persetujuan.legalisir')->with('success', 'Dokumen berhasil ditandatangani dengan QR digital. Status: Siap Diambil.');
