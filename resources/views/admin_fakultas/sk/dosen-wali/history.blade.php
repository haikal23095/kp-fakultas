...
@section('title', 'History SK Dosen Wali')
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 fw-bold mb-0">History SK Dosen Wali</h1>
        <p class="mb-0 text-muted">Riwayat SK Dosen Wali yang telah diproses</p>
    </div>
    <div>
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3">
        <h6 class="m-0 fw-bold text-success">
            <i class="fas fa-history me-2"></i>Riwayat SK Dosen Wali
        </h6>
    </div>
            ...
            <table class="table table-hover mb-0">
                <thead class="table-light">
                    <tr>
                        ...
                        <th width="12%" class="text-center">Jumlah Dosen</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <span class="badge bg-secondary">
                                <i class="fas fa-users me-1"></i>{{ $jumlahDosen }}
                            </span>
                        </td>
                        <td>
                            @php
                        ...
                        <td class="text-center">
                            <div class="btn-group btn-group-sm" role="group">
                                ...
                                <a href="{{ route('admin_fakultas.sk.dosen-wali.download', $sk->No) }}" 
                    ...
                    <tr>
                        <td colspan="8" class="text-center text-muted py-5">
                            ...
                            <p class="mb-0">Belum ada riwayat SK Dosen Wali</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
        ...
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title" id="modalDetailLabel">
                    <i class="fas fa-file-contract me-2"></i>Detail SK Dosen Wali
                </h5>
...
<script>
    ...
    function showDetail(skNo) {
        ...
        fetch(`{{ url('/admin-fakultas/sk/dosen-wali') }}/${skNo}/detail-history`, {
            method: 'GET',
            headers: {
    ...
    function renderDetail(sk) {
        ...
        dosenList.forEach(dosen => {
            const prodiName = dosen.prodi || 'Tidak ada prodi';
        ...
        const html = `
                ...
                <div class="col-md-6">
                    <table class="table table-borderless mb-0">
                        ...
                        <tr>
                            ...
                            <td><strong class="text-success">${dosenList.length} Dosen</strong></td>
                        </tr>
                        <tr>
            ...
            ${sk.Status === 'Ditolak-Wadek1' && sk['Alasan-Tolak'] ? `
            <div class="alert alert-danger mb-4">
                <div class="d-flex align-items-start">
                    <i class="fas fa-exclamation-circle fa-2x me-3"></i>
                    <div>
                        <h6 class="alert-heading fw-bold mb-2">SK Ditolak oleh Wadek 1</h6>
            ...
            <h6 class="fw-bold mb-3">Daftar Dosen Wali Per Program Studi</h6>
            ${prodiTablesHtml}
        `;
