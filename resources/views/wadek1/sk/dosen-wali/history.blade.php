...
@section('title', 'Riwayat SK Dosen Wali - Wadek 1')
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="mb-0 text-muted">Daftar SK Dosen Wali yang telah diproses</p>
    </div>
    <div>
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('wadek1.sk.dosen-wali.history') }}">
            <div class="row g-3">
                <div class="col-md-4">
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('wadek1.sk.dosen-wali.detail', $sk->{'Id-SK'} ?? $sk->No) }}" 
