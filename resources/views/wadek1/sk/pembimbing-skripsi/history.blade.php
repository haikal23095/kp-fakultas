...
@section('title', 'Riwayat SK Pembimbing Skripsi - Wadek 1')
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 fw-bold mb-0">Riwayat SK Pembimbing Skripsi</h1>
        <p class="mb-0 text-muted">Daftar SK Pembimbing Skripsi yang telah diproses</p>
    </div>
    <div>
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('wadek1.sk.pembimbing-skripsi.history') }}">
            <div class="row g-3">
                <div class="col-md-4">
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @php
                                // Ambil data pembimbing dari JSON
                    ...
                    <tr>
                        <td colspan="6" class="text-center py-4 text-muted">
                            ...
                            Belum ada riwayat SK Pembimbing Skripsi
                        </td>
                    </tr>
                    @endforelse
                </tbody>
                        ...
                        <tbody>
                            ${mahasiswaProdi.map((mhs, idx) => {
                                ...
                                const getNamaDosen = (dosen) => {
                                    ...
                                    return dosen.nama_dosen || dosen.nama || dosen.Nama_Dosen || dosen.Nama || '-';
                                };
                                
                                // Helper function untuk get NIP dengan berbagai kemungkinan field
                                const getNIP = (dosen) => {
                                    if (!dosen) return '-';
                                    if (typeof dosen === 'string') return '';
                                    return dosen.nip || dosen.NIP || '';
                                };
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 9pt;">
                                        ${getNamaDosen(mhs.pembimbing_1)}<br>
                                        <small>${getNIP(mhs.pembimbing_1) ? 'NIP: ' + getNIP(mhs.pembimbing_1) : ''}</small>
                                    </td>
                                    <td style="font-size: 9pt;">
                                        ${getNamaDosen(mhs.pembimbing_2)}<br>
                                        <small>${getNIP(mhs.pembimbing_2) ? 'NIP: ' + getNIP(mhs.pembimbing_2) : ''}</small>
                                    </td>
                                </tr>
                                `;
                            }).join('')}
