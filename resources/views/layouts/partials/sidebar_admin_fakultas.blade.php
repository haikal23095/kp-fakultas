<aside class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px; height: 100vh; position: fixed;">
    <a href="{{ route('dashboard.admin_fakultas') }}" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li class="nav-heading mt-3 mb-1 text-muted small">ADMIN FAKULTAS MENU</li>
        <li class="nav-item">
