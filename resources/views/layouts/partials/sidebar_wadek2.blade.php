<aside class="sidebar-mobile d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px; height: 100vh; position: fixed; z-index: 1045;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
            <a href="/dashboard/wadek2" class="nav-link text-white {{ request()->is('dashboard/wadek2') ? 'active' : '' }}">
                <i class="fas fa-home me-2"></i>
                Dashboard
            </a>
        </li>

        <li class="nav-heading mt-3 mb-1 small">WADEK 2 MENU</li>
        
        <li class="nav-item">
            <a class="nav-link text-white d-flex justify-content-between align-items-center" data-bs-toggle="collapse" href="#sarprasMenu" role="button" aria-expanded="false">
                <span><i class="fas fa-building me-2"></i>Sarana Prasarana</span>
                <i class="fas fa-chevron-down"></i>
            </a>
            <div class="collapse" id="sarprasMenu">
                <ul class="nav flex-column ms-3">
                    <li>
                        <a href="{{ route('wadek2.sarpras.persetujuan-mobil') }}" class="nav-link text-white {{ request()->is('wadek2/sarpras/persetujuan-mobil') ? 'active' : '' }}">
                            <i class="fas fa-car me-2"></i>Peminjaman Mobil
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('wadek2.sarpras.persetujuan-ruang') }}" class="nav-link text-white {{ request()->is('wadek2/sarpras/persetujuan-ruang') ? 'active' : '' }}">
                            <i class="fas fa-door-open me-2"></i>Peminjaman Ruang
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <li class="nav-item">
            <a class="nav-link text-white d-flex justify-content-between align-items-center" data-bs-toggle="collapse" href="#sdmMenu" role="button" aria-expanded="false">
                <span><i class="fas fa-users me-2"></i>SDM Kepegawaian</span>
                <i class="fas fa-chevron-down"></i>
            </a>
            <div class="collapse" id="sdmMenu">
                <ul class="nav flex-column ms-3">
                    <li>
                        <a href="{{ route('wadek2.sdm.validasi-cuti') }}" class="nav-link text-white {{ request()->is('wadek2/sdm/validasi-cuti') ? 'active' : '' }}">
                            <i class="fas fa-calendar-times me-2"></i>Validasi Cuti
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('wadek2.sdm.validasi-lembur') }}" class="nav-link text-white {{ request()->is('wadek2/sdm/validasi-lembur') ? 'active' : '' }}">
                            <i class="fas fa-clock me-2"></i>Validasi Lembur
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <li class="nav-item">
            <a href="{{ route('wadek2.sk.validasi-sk-fakultas') }}" class="nav-link text-white {{ request()->is('wadek2/sk/*') ? 'active' : '' }}">
    ...
    <div class="dropdown">
        <a href="#" class="user-dropdown d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <strong class="text-truncate-custom" style="flex: 1; min-width: 0;">{{ auth()->user()?->Name_User ?? 'Wadek 2' }}</strong>
        </a>
