...
<html>
<head>
    <title>Draft Surat Peminjaman Mobil Dinas</title>
    <style>
        @page {
...
<body>
    ...
    <div class="nomor-surat">
        ...
        @if($peminjaman->nomor_surat)
            <p>Nomor: {{ $peminjaman->nomor_surat }}</p>
        @else
            <p>Nomor: [Akan diberikan setelah disetujui]</p>
        @endif
    </div>
    ...
    {{-- Footer --}}
    <div class="footer">
        <p>Dokumen ini adalah draft dan akan sah setelah diberi nomor surat resmi</p>
    </div>
</body>
</html>
