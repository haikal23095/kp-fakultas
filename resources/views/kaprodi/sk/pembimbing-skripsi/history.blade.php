...
function renderPreviewKaprodi{{ $sk->No }}() {
    ...
    // Get Dekan info
    const dekanName = (accSK.dekan && accSK.dekan.Nama_Dosen) ? accSK.dekan.Nama_Dosen : 'Dekan Fakultas Teknik';
    const dekanNip = (accSK.dekan && accSK.dekan.NIP) ? accSK.dekan.NIP : '-';
        ...
        lampiranHtml += `
            <div class="lampiran-prodi" style="margin-top: ${index === 0 ? '30px' : '60px'}; page-break-before: ${index === 0 ? 'auto' : 'always'};">
                <div style="font-size: 11pt; text-align: left; margin-bottom: 10px;">
                    ...
                    <p style="margin: 0 0 10px 0; font-weight: normal; font-size: 9pt;">PENETAPAN DOSEN PEMBIMBING SKRIPSI PROGRAM STUDI S1 ${namaProdi} FAKULTAS TEKNIK UNIVERSITAS TRUNOJOYO MADURA SEMESTER ${semesterUpper} TAHUN AKADEMIK ${tahunAkademik}</p>
        ...
        <div style="text-align: justify; margin-bottom: 20px; font-size: 10pt;">
            ...
            <table style="width: 100%; margin-bottom: 15px;">
                <tr>
                    ...
                    <td>PENETAPAN DOSEN PEMBIMBING SKRIPSI PROGRAM STUDI S1 ${namaProdi} FAKULTAS TEKNIK UNIVERSITAS TRUNOJOYO MADURA SEMESTER ${semesterUpper} TAHUN AKADEMIK ${tahunAkademik}.</td>
                </tr>
            </table>
