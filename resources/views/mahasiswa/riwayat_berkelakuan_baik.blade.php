...
@section('title', 'Riwayat Surat Berkelakuan Baik')
    ...
    <div class="d-flex align-items-center justify-content-between">
        <div>
            <h3 class="mb-1 fw-bold text-dark">
                ...
                Riwayat Surat Keterangan Berkelakuan Baik
            </h3>
            <p class="mb-0 text-muted small">Pantau status pengajuan surat keterangan berkelakuan baik</p>
        </div>
        <div>
            <a href="{{ route('mahasiswa.pengajuan.kelakuan_baik.create') }}" class="btn btn-primary">
    ...
    <div class="card-body p-0">
        @if($riwayatSurat->isEmpty())
            <div class="empty-state">
                ...
                <p class="text-muted">Silakan ajukan surat keterangan berkelakuan baik</p>
                <a href="{{ route('mahasiswa.pengajuan.kelakuan_baik.create') }}" class="btn btn-primary mt-2">
                ...
                <table class="table table-clean" id="tableSurat" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {{-- Semester / TA --}}
                            <td>
                                @if($tugas->suratKelakuanBaik)
                                    <span class="fw-bold">{{ $tugas->suratKelakuanBaik->Semester }}</span>
                                    <br>
                                    <small class="text-muted">{{ $tugas->suratKelakuanBaik->Tahun_Akademik }}</small>
                                @else
                            ...
                            {{-- Keperluan --}}
                            <td>
                                {{ \Illuminate\Support\Str::limit($tugas->suratKelakuanBaik->Keperluan ?? '-', 50) }}
                            </td>
                            ...
                            <td>
                                ...
                                @elseif($status === 'menunggu-ttd')
                                    <span class="badge badge-clean bg-warning text-dark"><i class="fas fa-signature me-1"></i>Menunggu TTD</span>
                                @else
                            ...
                            <td class="text-center">
                                ...
                                @if($isSelesai)
                                    ...
                                    <a href="{{ route('mahasiswa.surat.download_berkelakuan_baik', $tugas->Id_Tugas_Surat) }}" 
