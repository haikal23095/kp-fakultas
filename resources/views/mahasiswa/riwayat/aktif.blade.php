...
@section('title', 'Riwayat Surat Keterangan Aktif')
    ...
    <div class="d-flex align-items-center justify-content-between">
        <div>
            <h3 class="mb-1 fw-bold text-dark">
                ...
                Riwayat Surat Keterangan Aktif
            </h3>
            <p class="mb-0 text-muted small">Pantau status pengajuan surat keterangan mahasiswa aktif</p>
        </div>
        <div>
    ...
    <div class="card-body p-0">
        @if($riwayatSurat->isEmpty())
            <div class="empty-state">
                ...
                <p class="text-muted">Silakan ajukan surat keterangan aktif kuliah</p>
                    ...
                    <tbody>
                        @foreach($riwayatSurat as $index => $surat)
                            <tr>
                                ...
                                <td>
                                    @if($surat->suratKetAktif && $surat->suratKetAktif->Nomor_Surat)
                                        <strong>{{ $surat->suratKetAktif->Nomor_Surat }}</strong>
                                    @else
                                        <span class="text-muted">Belum Terbit</span>
                                    @endif
                                </td>
                                <td>{{ \Illuminate\Support\Str::limit($surat->Deskripsi_Tugas_Surat, 50) }}</td>
                                <td class="text-center">
                                    @php
                                        // Status dari Surat_Ket_Aktif
                                        $statusRaw = $surat->suratKetAktif->Status ?? $surat->Status;
                                ...
                                <td class="text-center">
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary" 
                                            ...
                                            data-nomor="{{ $surat->suratKetAktif->Nomor_Surat ?? 'Belum Terbit' }}"
    ...
    <div class="col-md-12">
        <div class="alert alert-info border-0" role="alert">
            ...
            <div class="row small">
                ...
                <div class="col-md-3 mb-2">
                    <span class="badge bg-dark me-2">Terlambat</span> Melewati batas waktu
                </div>
            </div>
        </div>
    </div>
